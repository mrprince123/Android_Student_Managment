...
public class BiologyActivity extends AppCompatActivity {
    ...
    void initVideo() {
        ...
        bioVideo = findViewById(R.id.bio_video);
        getVideo();
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        bioVideo.setLayoutManager(layoutManager);
        bioVideo.setAdapter(videoAdapter);
    }
                ...
                try {
                    ...
                    if(videoObj.getString("success").equals("true")){
                        ...
                        for(int i = 0; i<videoArray.length(); i++){
                            ...
                            if(object.getString("subject").equals("Biology")){
